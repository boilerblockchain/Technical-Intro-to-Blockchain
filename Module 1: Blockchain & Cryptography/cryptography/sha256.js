...
class Sha256 {
  ...
  static hash(msg, options) {
    ...
    // STEP 1: convert string msg into 512-bit blocks (array of 16 32-bit integers) [§5.2.1]
    ...
    for (let i = 0; i < N; i++) {
      ...
      // STEP 2- prepare message schedule 'W'
      ...
      // STEP 3: main loop (note '>>> 0' for 'addition modulo 2^32')
      for (let t = 0; t < 64; t++) {
      ...
      // STEP 4: compute the new intermediate hash value (note '>>> 0' for 'addition modulo 2^32')
      H[0] = (H[0] + a) >>> 0;
      H[1] = (H[1] + b) >>> 0;
      H[2] = (H[2] + c) >>> 0;
      H[3] = (H[3] + d) >>> 0;
